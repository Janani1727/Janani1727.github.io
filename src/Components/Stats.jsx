...
const Stats = () => {
  return (
    <>
    <Box mt={["200px","30px","100px"]}>
    <Heading mr={["10%","60%","60%"]}  fontSize={["30px","30px","30px"]} color={"#fe8a91"}>My Github Stats 
    <Text mt={"-38px"} marginLeft={["300px","270px","470px"]}><FaGithub color='white' className='bounce'/></Text>
    </Heading>
