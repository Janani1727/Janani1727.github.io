...
export default function Home() {
    return (
        <>
            <div style={{ border: "0px solid white", height: "800px", fontFamily: "cursive", marginTop: "50px", fontSize: "50px" }}>
                ...
                <Flex>
                    ...
                    <Fade left>
                        <div>
                            <Image borderRadius={"50%"} width={"500px"} border={"15px solid #fd8990"} height={"450px"} marginLeft={"180px"} mt={"80px"} src={logo} />
                        </div>
                    </Fade>
                    ...
                    <div style={{border:"0px solid white",width:"800px",marginTop:"100px",marginLeft:"100px"}}> 
                            <Jump>
                            <h1 style={{color: "white",fontSize:"50px", textAlign:"left",marginTop:"20px"}}>About Me</h1>  
                            </Jump>
