...
export default function Home(){
    return(
        <>
        <div  className="home" style={{ marginTop:"88px",border:"0px solid white",height:"700px",fontFamily:"cursive",fontSize:"30px",display:"flex", zIndex:"99"}}>
              
                {/* <Flex> */}
                <div style={{ border:"0px solid green",width:"50%",marginTop:"100px",}}>
                <Fade left>
